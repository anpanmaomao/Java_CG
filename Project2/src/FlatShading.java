...
public class FlatShading extends JPanel{
    Canvas3D canvas;
    ...
    public BranchGroup createSceneGraph(){
        ...
        for(int i = 0; i < numTriangles; i++){
            ...
            triangles.setNormal(3 * i, normal);
            triangles.setNormal(3 * i + 1, normal);
            triangles.setNormal(3 * i + 2, normal);
	...
	// 	JFrame f = new FlatShading(args[0]);
	// 	f.setSize(800, 800);
	// 	f.setVisible(true);
